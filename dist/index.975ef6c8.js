...
searchForm.addEventListener("submit", async (e)=>{
    ...
    const perPage = 40;
    try {
        const response = await (0, _axiosDefault.default).get("https://pixabay.com/api/", {
            params: {
                key: apiKey,
                q: searchQuery,
                image_type: "photo",
        ...
        data.hits.forEach((image)=>{
            ...
            likes1.classList.add("info-item");
            likes1.innerHTML = `<b>Likes:</b> ${image.likes}`;
            const views1 = document.createElement("p");
            views1.classList.add("info-item");
            views1.innerHTML = `<b>Views:</b> ${image.views}`;
            const comments1 = document.createElement("p");
            comments1.classList.add("info-item");
            comments1.innerHTML = `<b>Comments:</b> ${image.comments}`;
            const downloads1 = document.createElement("p");
            downloads1.classList.add("info-item");
            downloads1.innerHTML = `<b>Downloads:</b> ${image.downloads}`;
            info.appendChild(likes1);
            info.appendChild(views1);
            info.appendChild(comments1);
            info.appendChild(downloads1);
...
loadMoreButton.addEventListener("click", async ()=>{
    ...
    try {
        ...
        data.hits.forEach((image)=>{
            ...
            likes2.classList.add("info-item");
            likes2.innerHTML = `<b>Likes:</b> ${image.likes}`;
            const views2 = document.createElement("p");
            views2.classList.add("info-item");
            views2.innerHTML = `<b>Views:</b> ${image.views}`;
            const comments2 = document.createElement("p");
            comments2.classList.add("info-item");
            comments2.innerHTML = `<b>Comments:</b> ${image.comments}`;
            const downloads2 = document.createElement("p");
            downloads2.classList.add("info-item");
            downloads2.innerHTML = `<b>Downloads:</b> ${image.downloads}`;
            info.appendChild(likes2);
            info.appendChild(views2);
            info.appendChild(comments2);
            info.appendChild(downloads2);
            photoCard.appendChild(img);
            photoCard.appendChild(info);
            gallery.appendChild(photoCard);
        });
...
data.hits.forEach((image)=>{
    ...
    const info = document.createElement("div");
    info.classList.add("info");
    const likes3 = document.createElement("span");
    likes3.classList.add("info-item");
    likes3.textContent = image.likes;
    const views3 = document.createElement("span");
    views3.classList.add("info-item");
    views3.textContent = image.views;
    const comments3 = document.createElement("span");
    comments3.classList.add("info-item");
    comments3.textContent = image.comments;
    const downloads3 = document.createElement("span");
    downloads3.classList.add("info-item");
    downloads3.textContent = image.downloads;
    info.appendChild(likes3);
    info.appendChild(views3);
    info.appendChild(comments3);
    info.appendChild(downloads3);
    photoCard.appendChild(img);
    photoCard.appendChild(info);
    gallery.appendChild(photoCard);
});
